...
|-----------|------------|--------|------|
| TC-001 | 测试 NacosConfig Bean 创建 | NacosConfigTest | ⏳ 待实现 |
| TC-002 | 测试 @EnableDiscoveryClient 注解生效 | NacosConfigTest | ⏳ 待实现 |
| TC-003 | 测试配置类条件注解 | NacosConfigTest | ⏳ 待实现 |
| TC-004 | 测试服务注册功能 | NacosDiscoveryTest | ⏳ 待实现 |
| TC-005 | 测试服务发现功能 | NacosDiscoveryTest | ⏳ 待实现 |
| TC-006 | 测试服务注销功能 | NacosDiscoveryTest | ⏳ 待实现 |
| TC-007 | 测试服务注册（register-enabled=false） | NacosDiscoveryTest | ⏳ 待实现 |
| TC-008 | 测试命名空间隔离 | NacosDiscoveryTest | ⏳ 待实现 |
| TC-009 | 测试服务分组功能 | NacosDiscoveryTest | ⏳ 待实现 |
| TC-010 | 测试配置读取功能 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-011 | 测试配置刷新功能 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-012 | 测试配置监听功能 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-013 | 测试共享配置文件 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-014 | 测试配置文件扩展名 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-015 | 测试配置前缀功能 | NacosConfigCenterTest | ⏳ 待实现 |
| TC-016 | 测试 Nacos 服务器连接成功 | NacosConnectionTest | ⏳ 待实现 |
| TC-017 | 测试 Nacos 服务器连接失败 | NacosConnectionTest | ⏳ 待实现 |
| TC-018 | 测试 Nacos 服务器连接超时 | NacosConnectionTest | ⏳ 待实现 |
| TC-019 | 测试 Nacos 认证功能 | NacosConnectionTest | ⏳ 待实现 |
| TC-020 | 测试 Nacos 认证失败 | NacosConnectionTest | ⏳ 待实现 |
| TC-021 | 测试服务发现配置属性 | NacosPropertiesTest | ⏳ 待实现 |
| TC-022 | 测试配置中心配置属性 | NacosPropertiesTest | ⏳ 待实现 |
| TC-023 | 测试配置属性默认值 | NacosPropertiesTest | ⏳ 待实现 |

### 5.2 待实现的测试用例

目前所有测试用例（TC-001 到 TC-023）均待实现。
